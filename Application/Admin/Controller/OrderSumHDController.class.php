...
class OrderSumHDController extends Controller {
    ...
    public function index(){
        ...
        if($filters['state_id'] == ''){
            $sql.=" and `order`.state_id in(4,5) ";
        }else if($filters['state_id'] != ''){
            $sql.=" and `order`.state_id = ".$filters['state_id']." ";
        }
...
//            .",`order`.re_type "
        ...
        if($filters['state_id'] == ''){
            $sql1.=" and `order`.state_id in(4,5) ";
        }else if($filters['state_id'] != ''){
            $sql1.=" and `order`.state_id = ".$filters['state_id']." ";
        }
