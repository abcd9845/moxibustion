...
var jsRootPath = "Loading.gif";

//增加路径识别
ZENG.RootPath = function () {
    var js = document.scripts;
    var jsPath;
    for (var i = js.length; i > 0; i--) {
        if (js[i - 1].src.indexOf("msgbox.js") > -1) {
            jsPath = js[i - 1].src.substring(0, js[i - 1].src.lastIndexOf("/"));
        }
    }

    jsRootPath = jsPath + "/Loading.gif";
};
ZENG.RootPath();
...
ZENG.msgbox.loadingAnimationPath = jsRootPath;// ZENG.RootPath() || ("loading.gif");
