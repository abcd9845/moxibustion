  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.container.find('.calendar')
            ...
            .on('click.daterangepicker', '.prev-year', $.proxy(this.clickPrevYear, this))
            .on('click.daterangepicker', '.next-year', $.proxy(this.clickNextYear, this))
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar.firstDay)) {
                html += '<th class="prev-year available"><i class="fa fa-angle-double-left"></i></th>';
            ...
            if (!maxDate || maxDate.isAfter(calendar.lastDay)) {
                ...
                html += '<th class="next-year available"><i class="fa fa-angle-double-right"></i></th>';
            } else {
                html += '<th></th>';
            }
