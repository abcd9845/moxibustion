...
class Pay {
    ...
    public function __construct($driver, $config = array()) {
        ...
        $this->config['notify_url'] = U("Pad/Alipay/notify", array('apitype' => $apitype, 'method' => 'notify'), false, true);
        $this->config['return_url'] = U("Pad/Alipay/notify", array('apitype' => $apitype, 'method' => 'return'), false, true);
