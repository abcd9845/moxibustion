...
return  array(
    ...
    /* 错误设置 */
    'ERROR_MESSAGE'         =>  '页面出点问题，小二正在处理!',//错误显示信息,非调试模式有效
    'ERROR_PAGE'            =>  __ROOT__.'/index.php/Pad/Index/errorPage',	// 错误定向页面
    ...
    'TMPL_ACTION_ERROR'     =>  THINK_PATH.'Tpl/gs_dispatch_jump.tpl', // 默认错误跳转对应的模板文件
    'TMPL_ACTION_SUCCESS'   =>  THINK_PATH.'Tpl/gs_dispatch_jump.tpl', // 默认成功跳转对应的模板文件
